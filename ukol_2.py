...
if kod in sklad:
    mnozstvi = int(input("Zadejte potřebné množství: "))
    if mnozstvi > sklad[kod]:
        print (f"Na skladě je k dispozici pouze: {sklad[kod]} ks.")
        sklad.pop(kod)
    else:
        print("Požadované množství je na skladě.")
        sklad[kod] = sklad[kod] - mnozstvi
elif kod not in sklad:
    print("Součástka není skladem.")

# NEPOVINNÝ BONUS_1:
    # Ve slovníku najdeš Morseovu abecedu, kde jako klíč slouží znak v klasické abecedě a jako hodnota zápis znaku v Morseově abecedě.
...
text = input("Zadejte text, který chcete převést do Morseovy abecedy: ")

for pismenko in text:
    if pismenko == " ":
        print ("/", end="")
    elif pismenko in morse_code:
        print(morse_code[pismenko], end=" ")

# NEPOVINNÝ BONUS_2:
    # Ve slovníku najdeš seznam slovníků s informacemi o státech světa. O každém státu tam vidíš následující informace: název státu (name), hlavní město (capital),region (region), subregion (subregion), populace (population), rozloha (area), Giniho koeficient (gini).
...
i = 0 # pomocná proměnná, která mi počítá kolikrát cyklus for zaznamenal shodu

region_dotaz = input("Zadejte název regionu: ")
